...
class App extends Component {
  ...
  componentDidMount() {
    const api =
      'https://raw.githubusercontent.com/EvilCult/iptv-m3u-maker/master/tv.json';
    fetch(api)
      .then((res) => res.json())
      .then((resData) => {
  ...
  render() {
    return (
      <div className="bp3-dark">
        ...
        <div className="main">
          <ReactPlayer
            url="https://stream.ads.ottera.tv/cl/230214cfleckjj1omgr51us7lg/1280x720_3071200_0_f.m3u8" //{this.state.playUrl}
            controls
            width="100%"
            height="315px"
  ...
  renderList() {
    ...
    const defaultList = [
      {
        title: 'CCTV-1',
        url: 'http://223.110.245.170/PLTV/3/224/3221226316/index.m3u8',
      },
      {
        title: 'CCTV-2',
      ...
      {
        title: 'CCTV-5',
        url: 'http://cctvcnch5c.v.wscdns.com/live/cctv5_2/index.m3u8',
      },
      {
        title: 'CCTV-6',
      ...
      {
        title: 'CCTV-8',
        url: 'http://223.110.245.170/ott.js.chinamobile.com/PLTV/3/224/3221227205/index.m3u8',
      },
      {
        title: 'CCTV-9',
        url: 'http://116.199.5.51:8114/index.m3u8?Fsv_chan_hls_se_idx=33&amp;FvSeid=1&amp;Fsv_ctype=LIVES&amp;Fsv_otype=1&amp;Provider_id=&amp;Pcontent_id=.m3u8',
      },
      {
        title: 'CCTV-10',
        url: 'http://223.110.245.170/ott.js.chinamobile.com/PLTV/3/224/3221225550/index.m3u8',
      },
      {
        title: 'CCTV-11',
      ...
      {
        title: 'CCTV-14',
        url: 'http://121.31.30.90:8085/ysten-business/live/cctv-14/yst.m3u8',
      },
      {
        title: 'CCTV-15',
        url: 'http://111.40.205.87/PLTV/88888888/224/3221225721/index.m3u8',
      },
    ];
    ...
    if (this.state.filterKey !== '') {
      urlList.forEach((item) => {
        if (
          item.title
            .toLowerCase()
            .indexOf(this.state.filterKey.toLowerCase()) >= 0
        ) {
          result.push(item);
        }
      });
  ...
  handleOpen = () =>
    this.setState({ menu: true, filterKey: '', playUrl: null, playing: false });
